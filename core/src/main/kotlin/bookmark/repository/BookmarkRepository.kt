...
interface BookmarkRepository : CoroutineCrudRepository<Bookmark, String>, BookmarkCustomRepository {
    suspend fun findFirstByUserIdAndYearAndSemester(userId: String, year: Int, semester: Semester): Bookmark?
    suspend fun existsByUserIdAndYearAndSemester(userId: String, year: Int, semester: Semester): Boolean
}
